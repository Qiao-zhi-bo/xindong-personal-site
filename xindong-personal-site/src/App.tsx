...
function Navigation() {
  ...
  return (
    <nav className="relative z-10 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
      ...
      >
        xindong<sup className="text-xs">®</sup>
      </a>
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mt-8 leading-relaxed animate-fade-rise-delay">
          I'm xindong — a hands-on creator working at the intersection of
          hardware, 3D, AI, and code. From soldering microcontrollers to
          rendering dreamscapes in Blender, every project is a step toward
          changing the world through practice.
        </p>
...
const skills = [
  {
    ...
    desc: '从 STM32 到 Arduino，在面包板上焊接理想，用 C 语言对话硬件。Soldering ideas onto breadboards, speaking C to silicon.',
  },
  {
    icon: Box,
    title: 'Blender / 中望3D',
    desc: '建模、渲染、动画，在三维空间里构建轨道、机械与想象中的世界。Building orbits, mechanisms, and imagined worlds in 3D.',
  },
  {
    icon: Video,
    title: 'AI 漫剧',
    desc: '用 AI 工具辅助分镜、上色与配音，把脑内的故事变成可观看的漫剧。Turning inner stories into watchable anime with AI.',
  },
  {
    icon: Code2,
    title: 'Mini Program',
    desc: '微信小程序开发，从赛博小狗到工具应用，让创意触达每个人的手机。WeChat mini-programs that bring ideas to every pocket.',
  },
  {
    icon: Gamepad2,
    title: 'Game Dev',
    desc: '像素平台跳跃、物理引擎实验，在游戏里实践最纯粹的交互乐趣。Pixel platformers & physics experiments — pure interactive joy.',
  },
]
...
const projects = [
  {
    title: '赛博小狗 / Cyber Puppy',
    desc: '微信小程序项目，科技风 UI 设计，带图解教程的硬件入门指南。A WeChat mini-program with a cyberpunk aesthetic and hardware tutorials.',
    tags: ['Mini Program', '前端', '硬件教程'],
    icon: Code2,
  },
  {
    title: '3D 轨道可视化',
    desc: '中望3D / Blender 建模的行星环与机械轨道结构，点云与线框渲染。Planetary rings & mechanical orbits, point-cloud & wireframe rendering.',
    tags: ['Blender', '中望3D', 'Visualization'],
    icon: Box,
  },
  {
    title: 'OLED 硬件实验',
    desc: '面包板上的蓝色 OLED 显示屏，用单片机驱动像素图案与交互原型。Blue OLED on a breadboard, pixel art driven by microcontrollers.',
    tags: ['单片机', 'OLED', 'Hardware DIY'],
    icon: Cpu,
  },
  {
    title: '像素平台游戏',
    desc: '复古像素风格 2D 平台跳跃游戏，含物理碰撞、金币收集与关卡设计。Retro pixel-art 2D platformer with physics, coins, and level design.',
    tags: ['Game Dev', 'Pixel Art', 'Platformer'],
    icon: Gamepad2,
  },
  {
    title: 'AI 漫剧创作',
    desc: '用 AI 辅助生成的动漫风格战斗场景，从分镜到成片的完整创作流程。AI-assisted anime battle scenes — from storyboard to final cut.',
    tags: ['AI漫剧', 'Storyboard', 'Animation'],
    icon: Video,
  },
]
  ...
  return (
    ...
    >
      <h2
        ...
        style={{ fontFamily: "'Instrument Serif', serif" }}
      >
        Projects <em className="not-italic text-muted-foreground">& Works</em>
      </h2>
  ...
  return (
    ...
    >
      <h2
        ...
        style={{ fontFamily: "'Instrument Serif', serif" }}
      >
        Contact <em className="not-italic text-muted-foreground">Me</em>
      </h2>

      <p className="text-muted-foreground text-base sm:text-lg max-w-xl mx-auto mb-12 leading-relaxed">
        Have a collab idea, tech question, or just want to talk about creating?
        Reach out anytime.
      </p>
      ...
      <p
        ...
        style={{ fontFamily: "'Instrument Serif', serif" }}
      >
        © 2026 xindong® — Practice changes the world.
      </p>
    </section>
  )
}
